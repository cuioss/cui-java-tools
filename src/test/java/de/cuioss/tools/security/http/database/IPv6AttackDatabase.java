...
public class IPv6AttackDatabase implements AttackDatabase {
    ...
    public static final AttackTestCase IPV4_MAPPED_LOCALHOST_BYPASS = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because despite the IPv6 addressing complexity, the primary attack vector is directory traversal (../../../) to access unauthorized system files outside the web root."
    );
    ...
    public static final AttackTestCase IPV4_MAPPED_PRIVATE_NETWORK = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the core attack mechanism uses directory traversal sequences (../../) to access sensitive files, with IPv6 addressing serving as an access control bypass technique."
    );
    ...
    public static final AttackTestCase IPV4_MAPPED_RFC6052 = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the attack uses administrative directory traversal (admin/../) to access system files, with the IPv6 addressing format serving as a network access control bypass mechanism."
    );
    ...
    public static final AttackTestCase IPV6_LOCALHOST_CANONICAL = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected due to the directory traversal pattern (../../) designed to escape the web root and access sensitive system files, regardless of the IPv6 addressing format."
    );
    ...
    public static final AttackTestCase IPV6_LOCALHOST_EXPANDED = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the attack employs directory traversal (../) to access administrative configuration files outside the intended directory structure."
    );
    ...
    public static final AttackTestCase IPV6_LOCALHOST_LEADING_ZEROS = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the primary attack mechanism uses directory traversal sequences to access the system hosts file outside the web application's intended directory scope."
    );
    ...
    public static final AttackTestCase MALFORMED_TRIPLE_COLON = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the malformed IPv6 syntax (:::1) represents an invalid address format that may indicate parser confusion attacks or IPv6 validation bypass attempts."
    );
    ...
    public static final AttackTestCase MALFORMED_MULTIPLE_COMPRESSION = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the syntactically invalid IPv6 format containing multiple compression attempts (:::), indicating potential IPv6 parser exploitation or validation bypass techniques."
    );
    ...
    public static final AttackTestCase INVALID_HEX_CHARACTERS = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the presence of invalid hexadecimal characters (g) in IPv6 addresses indicates malformed network addressing that may be used to exploit parser weaknesses."
    );
    ...
    public static final AttackTestCase ZONE_ID_INTERFACE_ATTACK = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because despite the IPv6 zone identifier complexity, the core attack uses directory traversal (../../) to access unauthorized system files outside the intended directory structure."
    );
    ...
    public static final AttackTestCase ZONE_ID_PATH_INJECTION = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the zone identifier contains embedded path traversal sequences (../../../etc) designed to escape directory boundaries through IPv6 address parsing manipulation."
    );
    ...
    public static final AttackTestCase ZONE_ID_PRIVILEGE_ESCALATION = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the attack combines directory traversal (../../) with potential privilege context injection through the IPv6 zone identifier, targeting configuration file access."
    );
    ...
    public static final AttackTestCase BRACKET_REVERSAL_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because reversed IPv6 brackets (]...[) violate standard IPv6 URL format specifications and may indicate URL parsing exploitation attempts."
    );
    ...
    public static final AttackTestCase BRACKET_NESTING_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because nested IPv6 brackets ([[...]]) represent malformed URL syntax that may be used to exploit IPv6 address parsing inconsistencies."
    );
    ...
    public static final AttackTestCase BRACKET_INJECTION_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the malformed bracket sequence (][...][) that violates IPv6 URL syntax and indicates potential parser confusion or injection attacks."
    );
    ...
    public static final AttackTestCase COMPRESSION_OVERFLOW_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because excessive compression sequences (::::::1) violate IPv6 addressing standards and indicate potential parser confusion attacks or address validation bypass attempts."
    );
    ...
    public static final AttackTestCase COMPRESSION_ISOLATION_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because address formats consisting only of compression sequences (::::::::) are invalid IPv6 syntax that may be used to exploit parser edge cases."
    );
    ...
    public static final AttackTestCase FRAGMENTED_COMPRESSION_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the combination of valid IPv6 parts (2001, db8) with invalid compression sequences (:::::::) creates malformed addresses indicating parser exploitation attempts."
    );
    ...
    public static final AttackTestCase IPV6_INVALID_PORT_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because alphabetic port specifications (:abc) violate URL standards and may indicate attempts to exploit port parsing vulnerabilities or bypass port-based security controls."
    );
    ...
    public static final AttackTestCase IPV6_NEGATIVE_PORT_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because negative port numbers (:-80) are invalid in URL specifications and may indicate attempts to exploit port parsing edge cases or bypass port validation mechanisms."
    );
    ...
    public static final AttackTestCase IPV6_PORT_OVERFLOW_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because port numbers exceeding 65535 (:999999) violate TCP/UDP port specifications and may indicate attempts to exploit port parsing vulnerabilities."
    );
    ...
    public static final AttackTestCase FULL_EXPANSION_TRAVERSAL = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because despite the complex IPv6 addressing, the attack uses extensive directory traversal sequences to access system files outside the intended directory structure."
    );
    ...
    public static final AttackTestCase ZONE_EMBEDDED_TRAVERSAL = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the zone identifier contains embedded directory traversal sequences (../../etc/passwd) designed to escape directory boundaries through IPv6 address parsing manipulation."
    );
    ...
    public static final AttackTestCase BRACKET_TRAVERSAL_HYBRID = new AttackTestCase(
            ...
            "PATH_TRAVERSAL_DETECTED is expected because the attack uses directory traversal patterns (../../../) to access Windows system files, with IPv6 bracket malformation serving as a potential parser confusion technique."
    );
