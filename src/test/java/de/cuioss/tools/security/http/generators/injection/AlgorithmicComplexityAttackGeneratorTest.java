...
/**
 * QI-5: Basic generator test for AlgorithmicComplexityAttackGenerator.
 * 
 * <p>
...
class AlgorithmicComplexityAttackGeneratorTest {

    @ParameterizedTest
    @TypeGeneratorSource(value = AlgorithmicComplexityAttackGenerator.class, count = 10)
    @DisplayName("Generator should produce valid non-null algorithmic complexity attack patterns")
    void shouldGenerateValidOutput(String generatedValue) {
        ...
        assertTrue(generatedValue.length() > 3, "Attack patterns should be meaningful (more than 3 characters)");
    }
}