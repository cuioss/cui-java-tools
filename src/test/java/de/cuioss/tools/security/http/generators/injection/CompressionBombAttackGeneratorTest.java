...
/**
 * QI-5: Basic generator test for CompressionBombAttackGenerator.
 * 
 * <p>
...
class CompressionBombAttackGeneratorTest {

    @ParameterizedTest
    @TypeGeneratorSource(value = CompressionBombAttackGenerator.class, count = 10)
    @DisplayName("Generator should produce valid non-null compression bomb attack patterns")
