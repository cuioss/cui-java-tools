 ...
 * 
 * @deprecated This test is for the deprecated mixed-purpose CookieGenerator.
 * Use {@link de.cuioss.tools.security.http.generators.cookie.ValidCookieGeneratorTest} and {@link de.cuioss.tools.security.http.generators.cookie.AttackCookieGeneratorTest} instead.
 * The original generator violates framework compliance with call-counter anti-pattern
 * and mixed legitimate/attack data.
 */
