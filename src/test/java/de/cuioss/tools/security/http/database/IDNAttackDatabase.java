...
public class IDNAttackDatabase implements AttackDatabase {
    ...
    public static final AttackTestCase CYRILLIC_APPLE_HOMOGRAPH = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the Cyrillic character 'а' creates visual deception in the domain name, representing a classic homograph attack pattern combined with directory traversal sequences."
    );
    ...
    public static final AttackTestCase CYRILLIC_GOOGLE_HOMOGRAPH = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the presence of Cyrillic characters in what appears to be a Latin domain name, indicating potential homograph spoofing combined with unauthorized directory access."
    );
    ...
    public static final AttackTestCase CYRILLIC_MICROSOFT_HOMOGRAPH = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the Cyrillic 'с' character creates a homograph spoofing attack against the Microsoft brand, combined with directory traversal patterns."
    );
    ...
    public static final AttackTestCase CYRILLIC_PAYPAL_HOMOGRAPH = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to multiple Cyrillic character substitutions creating a convincing paypal.com homograph, combined with path traversal to sensitive system files."
    );
    ...
    public static final AttackTestCase PUNYCODE_APPLE_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because punycode domains (xn--) can indicate internationalized domain name attacks, and the decoded form reveals homograph spoofing."
    );
    ...
    public static final AttackTestCase PUNYCODE_RUSSIAN_DOMAIN = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected for punycode domains that may be used to disguise the true nature of international character domains, combined with directory traversal patterns."
    );
    ...
    public static final AttackTestCase PUNYCODE_CHINESE_ATTACK = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because short punycode domains often indicate suspicious internationalized domain usage, combined with administrative path traversal attempts."
    );
    ...
    public static final AttackTestCase MIXED_SCRIPT_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because mixing scripts from different Unicode blocks (Latin + Cyrillic) in a single domain is a strong indicator of homograph spoofing attempts."
    );
    ...
    public static final AttackTestCase ARMENIAN_PERIOD_TWITTER = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because non-ASCII punctuation characters in domain names, especially those visually similar to periods, indicate advanced homograph attacks."
    );
    ...
    public static final AttackTestCase HYPHENATION_POINT_INSTAGRAM = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the use of Unicode punctuation that mimics ASCII period characters, combined with directory traversal to access sensitive system files."
    );
    ...
    public static final AttackTestCase COMPOSED_ACCENT_CAFE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because accented characters in domain names may indicate normalization bypass attempts or internationalized domain attacks."
    );
    ...
    public static final AttackTestCase DECOMPOSED_ACCENT_CAFE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because combining characters and escape sequences (\\u0301) in URLs often indicate attempts to bypass security filters through Unicode normalization differences."
    );
    ...
    public static final AttackTestCase RTL_OVERRIDE_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because RTL override characters (U+202E) in domain names are strong indicators of bidirectional text spoofing attacks designed to deceive users about the true domain."
    );
    ...
    public static final AttackTestCase RTL_MIDDLE_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the presence of RTL override control characters within domain names, indicating bidirectional text manipulation for spoofing purposes."
    );
    ...
    public static final AttackTestCase ZERO_WIDTH_SPACE_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because zero-width characters in domain names are indicators of steganographic attacks designed to hide malicious domains within legitimate-appearing URLs."
    );
    ...
    public static final AttackTestCase ZERO_WIDTH_NON_JOINER = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because zero-width non-joiner characters in domain names indicate attempts to create visually deceptive domains that bypass string-based security filters."
    );
    ...
    public static final AttackTestCase SOFT_HYPHEN_TWITTER = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because soft hyphen characters in domain names are used to create visually deceptive domains that appear legitimate while bypassing exact string matching security filters."
    );
    ...
    public static final AttackTestCase FULL_WIDTH_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because full-width Unicode characters in domain names often indicate attempts to create visually similar domains for spoofing purposes."
    );
    ...
    public static final AttackTestCase MATHEMATICAL_BOLD_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because mathematical Unicode characters in domain names are strong indicators of advanced homograph spoofing using specialized Unicode blocks."
    );
    ...
    public static final AttackTestCase MATHEMATICAL_ITALIC_GOOGLE = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because mathematical italic Unicode characters in domains indicate advanced homograph attacks using specialized mathematical character sets."
    );
    ...
    public static final AttackTestCase PUNYCODE_PORT_TRAVERSAL = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because the combination of punycode domains, non-standard ports, and path traversal represents a complex multi-vector attack pattern."
    );
    ...
    public static final AttackTestCase MIXED_SCRIPT_HTTPS_TRAVERSAL = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected because mixed script domains over HTTPS with administrative path traversal represent sophisticated social engineering combined with technical exploitation."
    );
    ...
    public static final AttackTestCase CYRILLIC_ZERO_WIDTH_TRAVERSAL = new AttackTestCase(
            ...
            "SUSPICIOUS_PATTERN_DETECTED is expected due to the combination of homograph characters and invisible Unicode characters in the domain, representing a multi-vector deception attack."
    );
