...
class UrlSecurityExceptionTest {
    ...
    void shouldBuildFullException() {
        Throwable cause = /*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*/new RuntimeException("Root cause");
    ...
    void shouldSupportFluentBuilding() {
        UrlSecurityException exception = UrlSecurityException.builder()
                ...
                .sanitizedInput(TEST_SANITIZED)
                .detail(TEST_DETAIL)
                .cause(/*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*/new RuntimeException())
                .build();
    ...
    void shouldSupportCauseChaining() {
        RuntimeException rootCause = /*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*/new RuntimeException("Root cause");
    ...
    void shouldSupportMethodChaining() {
        ...
        assertSame(builder.getClass(),
                builder.cause(/*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*//*~~(Use specific not RuntimeException)~~>*/new RuntimeException()).getClass());
    }
