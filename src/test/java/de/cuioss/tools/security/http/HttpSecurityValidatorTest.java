...
class HttpSecurityValidatorTest {
    ...
    void shouldWorkWithStreams() {
        ...
        java.util.List<String> inputs = java.util.Arrays.asList(" hello ", " world ", null);
        java.util.List<String> outputs = inputs.stream()
                .map(validator::validate)
                .collect(java.util.stream.Collectors.toList());
        
        assertEquals(java.util.Arrays.asList("hello", "world", ""), outputs);
    }
