...
/**
 * QI-5: Basic generator test for OWASPTop10AttackGenerator.
 * 
 * <p>
...
class OWASPTop10AttackGeneratorTest {

    @ParameterizedTest
    @TypeGeneratorSource(value = OWASPTop10AttackGenerator.class, count = 10)
    @DisplayName("Generator should produce valid non-null OWASP Top 10 attack patterns")
    void shouldGenerateValidOutput(String generatedValue) {
        ...
        assertTrue(generatedValue.length() > 5, "OWASP attack patterns should be meaningful (more than 5 characters)");
    }
}