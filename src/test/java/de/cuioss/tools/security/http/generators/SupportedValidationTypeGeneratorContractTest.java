...
class SupportedValidationTypeGeneratorContractTest extends GeneratorContractTestBase<ValidationType> {
    ...
    void demonstrateGeneratorOutput() {
        ...
        /*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*/System.out.println("SupportedValidationTypeGenerator sample outputs:");
        for (int i = 0; i < samples.size(); i++) {
            /*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*/System.out.printf("  [%d]: %s%n", i + 1, samples.get(i));
        }
    }
}