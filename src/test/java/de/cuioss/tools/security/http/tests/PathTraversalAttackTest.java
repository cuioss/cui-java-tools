...
class PathTraversalAttackTest {
    ...
    void shouldMaintainPerformanceUnderAttack() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            } /*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*/catch (Exception ignored) {
            }
        }
