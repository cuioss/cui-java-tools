...
class PathTraversalAttackTest {
    ...
    void shouldMaintainPerformanceUnderAttack() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            } /*~~(Catch specific not RuntimeException)~~>*//*~~(Catch specific not RuntimeException)~~>*//*~~(Catch specific not RuntimeException)~~>*//*~~(Catch specific not RuntimeException)~~>*//*~~(Catch specific not RuntimeException)~~>*/catch (RuntimeException ignored) {
            }
        }
