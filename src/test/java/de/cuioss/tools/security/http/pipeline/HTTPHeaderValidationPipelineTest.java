...
import de.cuioss.tools.security.http.generators.header.HTTPHeaderInjectionGenerator;
import de.cuioss.tools.security.http.generators.header.InvalidHTTPHeaderNameGenerator;
