 ...
 * @since 2.5
 * @see de.cuioss.tools.security.http.database.AttackDatabase
 * @see de.cuioss.tools.security.http.database.AttackTestCase
 * @see de.cuioss.tools.security.http.core.UrlSecurityFailureType
 */
