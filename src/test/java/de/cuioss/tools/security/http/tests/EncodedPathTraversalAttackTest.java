    ...
    void shouldHandleLegitimateEncodedCharacters() {
        ...
        for (String pattern : legitimatePatterns) {
            try {
                ...
                /*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*//*~~(Use CuiLogger)~~>*/System.out.println("Legitimately blocked (security-first): " + pattern + " - " + e.getMessage());
            }
        }
    }
    ...
    void shouldBeThreadSafe() throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            threads[i] = new Thread(() -> {
                ...
                } /*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*//*~~(Catch specific not Exception)~~>*/catch (Exception e) {
