...
import static io.cui.util.collect.CollectionLiterals.immutableSet;
import static io.cui.util.collect.CollectionLiterals.immutableSortedSet;
...
import static io.cui.util.collect.CollectionLiterals.mutableSet;
import static io.cui.util.collect.CollectionLiterals.mutableSortedSet;
...
class CollectionLiteralsTest {
    ...
    void shouldHandleMutableSortedSet() {
        ...
        assertMutable(mutableSortedSet((Iterable<String>) Arrays.asList("1", "2")));
    ...
    void shouldHandleImmutableSortedSet() {
        ...
        assertImmutable(immutableSortedSet((Iterable<String>) Arrays.asList("1", "2")));
