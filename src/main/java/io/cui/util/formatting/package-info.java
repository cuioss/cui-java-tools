 ...
 * <h3>The Solution</h3>
 * <p>
 * The {@link io.cui.util.formatting} framework presented here.
 * </p>
 * <p>
 * The starting point is {@link io.cui.util.formatting.template.FormatterSupport} providing two
 * methods:
 * <ul>
 * <li>{@link io.cui.util.formatting.template.FormatterSupport#getSupportedPropertyNames()}:
 * Provides the property names that can be used for formatting</li>
 * <li>{@link io.cui.util.formatting.template.FormatterSupport#getAvailablePropertyValues()}:
 * Provides a name with with the supported names and values.</li>
 * </ul>
 * <p>
 * <p>
 * The other interface needed is {@link io.cui.util.formatting.template.TemplateFormatter} defining
 * the method
 * {@link io.cui.util.formatting.template.TemplateFormatter#format(io.cui.util.formatting.template.FormatterSupport)}
 * doing the actual formatting.
 * </p>
 * <h3>Sample</h3>
 * Dto PersonName implementing {@link io.cui.util.formatting.template.FormatterSupport}
 *
 * <pre>
 * <code>
