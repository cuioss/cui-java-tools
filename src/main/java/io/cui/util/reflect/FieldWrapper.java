...
import io.cui.util.lang.SecuritySupport;
...
/**
 * Wrapper around a {@link Field} that handles implicitly the accessible flag for access.
 *
 * @author Oliver Wolff
 *
 */
...
public class FieldWrapper {
    ...
    /**
     * Reads from the field determined by {@link #getField()}. It implicitly sets and resets the
     * {@link Field#isAccessible()} flag.
     *
     * @param object to be read from
     * @return an {@link Optional} on the given field value if applicable. May return
     *         {@link Optional#empty()} for cases where:
     *         <ul>
    ...
    /**
     * Writes to the field determined by {@link #getField()}. It implicitly sets and resets the
     * {@link Field#isAccessible()} flag.
     *
     ...
     * @throws IllegalArgumentException in case the value is not applicable to the field
