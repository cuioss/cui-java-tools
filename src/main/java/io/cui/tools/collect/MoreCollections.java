 ...
 *
 * <h3>isEmpty()</h3>
 * The overloaded method {@link MoreCollections#isEmpty(Collection)} checks all kinds of
 * Collections / varargs parameter for not being null and emptiness. In case of {@link Stream}s it
 * solely checks for being not null in order not to consume it.
 *
 * <h3>requireNotEmpty()</h3>
 * The overloaded method {@link MoreCollections#requireNotEmpty(Collection)} checks all kinds of
 * Collections / varargs parameter for not being null nor empty. In case of being null / empty they
...
public final class MoreCollections {
     ...
     *
     * @param map to be checked. If it is {@code null} or empty the method will always return
     *            {@code false}
