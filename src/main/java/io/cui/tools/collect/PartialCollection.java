 ...
 * provides more data than the current {@link io.cui.tools.collect.PartialCollection}. It defines
 * the lower bound for the
 * contained types to {@link java.io.Serializable}. Currently, the only implementation is
 * {@link io.cui.tools.collect.PartialArrayList}. It provides convenient methods for instantiation,
 * like
