...
public class PumpStreamHandler implements ExecuteStreamHandler {
    ...
    private static final Logger log = new Logger(PumpStreamHandler.class);
     ...
     */
    @SuppressWarnings("squid:S106") // owolff: Catching the streams is the actual use-case
     ...
     */
    @Override
    @SuppressWarnings("squid:S2142") // owolff: taken from original. Handling not necessary in this
                                     // usage context
    public void stop() {
        if (inputThread != null) {
