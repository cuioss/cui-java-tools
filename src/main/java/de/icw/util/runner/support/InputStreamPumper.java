 ...
 * @author mkleint
 * @author Copied from
 *         https://github.com/zeroturnaround/zt-exec/blob/master/src/main/java/org/zeroturnaround/exec/stream/InputStreamPumper.java
 */
public class InputStreamPumper implements Runnable {

    private static final Logger log = new Logger(InputStreamPumper.class);
    ...
    /**
     * Sets the stop flag to {@code true}
     */
