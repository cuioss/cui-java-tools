 ...
 * 
 * @author Copied from
 *         https://github.com/zeroturnaround/zt-exec/blob/master/src/main/java/org/zeroturnaround/exec/close/ProcessStreamCloser.java
 * 
 */
public interface ProcessStreamCloser {
