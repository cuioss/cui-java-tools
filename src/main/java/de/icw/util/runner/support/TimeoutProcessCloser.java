...
/**
 * Same as {@link StreamHandleCloser} but only waits fixed period for the closing.
 ...
 */
public class TimeoutProcessCloser extends StreamHandleCloser {

    private static final Logger log = new Logger(TimeoutProcessCloser.class);
