...
https://sonarcloud.io/summary/new_code?id=cuioss_cui-java-tools[image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_cui-java-toolss&metric=alert_status[Quality
Gate Status]]
