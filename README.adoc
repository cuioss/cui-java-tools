...
https://sonarcloud.io/summary/new_code?id=cuioss_cuioss-java-tools[image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_cuioss-java-toolss&metric=alert_status[Quality
Gate Status]]
...
image:https://maven-badges.herokuapp.com/maven-central/io.github.cuioss/cui-java-tools/badge.svg[Maven Central,link=https://maven-badges.herokuapp.com/maven-central/io.github.cuioss/ccui-java-tools]
