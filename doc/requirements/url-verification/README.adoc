= Path Traversal Security Documentation
:toc: left
:toclevels: 2
:icons: font
...
link:../../http-verification/specification/testing.adoc[Testing Framework]::
...
4. Validate with link:../../http-verification/specification/testing.adoc#_test_data_categories[Test Data Categories]
