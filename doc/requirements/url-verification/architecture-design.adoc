 ...
 */
public record UrlSecurityException(
    ...
    /**
     * Constructor with cause support.
     */
    public static UrlSecurityException withCause(
        ...
        var ex = new UrlSecurityException(failureType, validationType, originalInput, sanitizedInput, detail);
        if (cause != null) {
            ex.initCause(cause);
        }
        return ex;
