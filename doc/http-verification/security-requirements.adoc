...
| SEC-OWASP-1 | Injection Prevention | link:analysis/owasp-best-practices.adoc#_a032021_injection[OWASP A03]
| SEC-OWASP-2 | Access Control | link:analysis/owasp-best-practices.adoc#_a012021_broken_access_control[OWASP A01]
| SEC-OWASP-3 | Secure Design | link:specification/specification.adoc#_defense_in_depth[Architecture]
| SEC-PATH-1 | Traversal Detection | link:analysis/cve-analysis.adoc[CVE Analysis]
...
| SEC-UPDATE-2 | Threat Intelligence | link:analysis/cve-analysis.adoc[Threats]
|===